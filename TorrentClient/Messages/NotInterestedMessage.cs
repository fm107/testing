namespace Torrent.Client.Messages
{
    ...
    public class NotInterestedMessage : PeerMessage
    {
        ...
        /// <summary>
        ///     Determines wheteher this NotInterestedMessage instance and a specified object, which also must be a
        ///     NotInterestedMessage object, have the same data values.
        /// </summary>
