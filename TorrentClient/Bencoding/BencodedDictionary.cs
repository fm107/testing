...
namespace Torrent.Client.Bencoding
{
    ...
    {
        private readonly Dictionary<string, IBencodedElement> _innerDictionary;
        ...
        {
            _innerDictionary = new Dictionary<string, IBencodedElement>();
        }
        ...
        public override string ToString()
        {
            ...
            foreach (var el in _innerDictionary)
