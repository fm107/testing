...
namespace Torrent.Client
{
    public abstract class TorrentMode
    {
        ...
        protected TorrentMode(BlockManager manager, BlockStrategist strategist, TorrentData metadata,
            TransferMonitor monitor)
        {
            ...
            DefaultHandshake = new HandshakeMessage(Global.Instance.PeerId, new byte[8], Metadata.InfoHash,
                "BitTorrent protocol");
            ...
            KeepAliveTimer = new Timer(SendKeepAlives, new object(), 0, Timeout.Infinite);
        }
        ...
        public TorrentData Metadata { get; }
